...
[CreateAssetMenu(menuName = "Strategy Game/Enemy Behaviors/Warper")]
public class WarperEnemyBehavior : EnemyBehavior
{
    public int Damage = 5;
    ...
    {
        //gamemanger will handle the cross timeline attacks.
